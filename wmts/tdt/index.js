require([
    ...
    "tdt/TdtTileInfo.js",
    "tdt/TdtTileInfoNoEncrypt.js",
    "tdt/TdtUrlTemplates.js",
     ...
     */
    // esriConfig.request.proxyUrl="t0.tianditu.com";
    ...
    var TDT_Layer = new WebTileLayer({
      ...
      subDomains: ["t0","t1","t2","t4"]
    });
    var TDT_Layer1= new WebTileLayer({
        id: "Tianditucia",
        title: "Tianditu Mark Label",
        tileInfo: tileInfo,
        spatialReference: spatialReference,
        urlTemplate: TdtUrlTemplates.CIA,
        subDomains: ["t0","t1","t2","t4"]
      });
  
    map.addMany([TDT_Layer,TDT_Layer1]);
  });
